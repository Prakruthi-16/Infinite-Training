...
namespace RailwayReservationSystem
{
    class Program
    {
        ...
        static void ViewAllBookings()
        {
            ...
            {
                Console.WriteLine($"BookingId: {booking.BookingId}, UserId: {booking.UserId}, TrainNo: {booking.TrainNo}, ClassOfTravel: {booking.ClassOfTravel}, SeatsBooked: {booking.SeatsBooked}");
            }
        }
        ...
        static void ViewAllCancellations()
        {
            ...
            {
                Console.WriteLine($"CancellationId: {cancellation.CancellationId}, BookingId: {cancellation.BookingId}, SeatsCancelled: {cancellation.SeatsCancelled}");
            }
        }
        ...
        static void UserBookingOptions(User user)
        {
            while (true)
            {
                ...
                Console.WriteLine("4. ViewAll Booking Tickets");
                Console.WriteLine("5. View Booking Cancellation");
        ...
        static void ViewAllCancellationss()
        {
            List<Cancellation> cancellations = adminService.GetAllCancellations();
            foreach (var cancellation in cancellations)
            {
